  ...
  return (
      <Tooltip title={t('send-message')} side="top" sideOffset={0}>
        <button
            ...
            className="p-1 px-4 mr-2 rounded-md text-black dark:disabled:text-white/40 enabled:text-white dark:enabled:text-white enabled:bg-black dark:enabled:bg-gray-800 disabled:text-white/40 relative z-10"
        >
          {loading ? (
