...
const App = () => {
  ...
  // Use MainPage directly and pass sidebar props; avoid creating a wrapper component inside App
  // which would create a new component type on every render and cause remounts.
  return (
      <BrowserRouter>
